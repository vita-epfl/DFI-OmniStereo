...
class DPT_DINOv2(nn.Module):
    def __init__(self, encoder='vitl', features=256, use_bn=False, out_channels=[256, 512, 1024, 1024], use_clstoken=False):
        ...
        if not os.path.exists(path):
            depth_anything_directory = '/mnt/vita/scratch/vita-students/users/endres/omnidirectional-depth-estimation/src/models/depth_anything/'
            path = os.path.join(depth_anything_directory, path)
